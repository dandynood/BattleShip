...
static class DeploymentController
{
	...
	public static void HandleDeploymentInput()
	{
		...
		if (SwinGame.MouseClicked(MouseButton.LeftButton)) {
			...
			//direction change from leftright to updown
	...
	private static void DoDeployClick()
	{
		...
		//fix the location bugs when user clicking *just change old row code to the same as col and change the mouse.X to mouse.Y and CELL_WIDTH to CELL_HEIGHT*
